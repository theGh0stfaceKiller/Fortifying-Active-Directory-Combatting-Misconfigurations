...
2. **Misconfigured [Active Directory Certifcate Servics (ADCS)](https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/active-directory-certificate-services-overview)**:
